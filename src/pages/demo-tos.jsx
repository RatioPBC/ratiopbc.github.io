  ...
  return (
    <>
      ...
      <section id="terms-of-service" className="container mx-auto px-4 py-8">
        <h1 className="text-text-100 mt-1 text-2xl font-bold" level="1">
          Terms of Service and Privacy Policy for Application Demo
        </h1>
        <h2 className="text-text-100 -mb-0.5 mt-1 text-xl font-bold" level="2">
          Terms of Service
        </h2>
        ...
        <ul
          className="list-disc space-y-1.5 pl-7 [&:not(:last-child)_ol]:pb-1 [&:not(:last-child)_ul]:pb-1"
          depth="0"
        >
          <li className="whitespace-normal break-words" index="0">
            Violate any applicable laws
          </li>
          <li className="whitespace-normal break-words" index="1">
            Infringe upon the rights of others
          </li>
          <li className="whitespace-normal break-words" index="2">
        ...
        <h3 className="text-text-100 -mb-1.5 mt-1 text-lg font-bold" level="3">
          12. Carrier Liability
        </h3>
        <p>
          Carriers are not liable for delayed or undelivered messages
        </p>
        <h3 className="text-text-100 -mb-1.5 mt-1 text-lg font-bold" level="3">
          12. Message and Data Rates
        </h3>
        <p>
          As always, message and data rates may apply for any messages sent to
          you from us and to us from you. You will receive a message only when
          you submit your information for the demo. If you have any questions
